...
// Swiper pagination
document.addEventListener('DOMContentLoaded', () => {
	let pagWrap = document.getElementById("swiper-pagination-offers");
	let nodePrev = document.getElementById("swiper-pagination-offers-prev");
	let nodeNext = document.getElementById("swiper-pagination-offers-next");
